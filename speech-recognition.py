...
with sr.Microphone() as source:
    print("Hello, what can i help you find?[Player lookup,Weather,resturants,porn or just to search the web: ]")
...
if "porn" in r.recognize_google(audio):
    # obtain audio from the microphone
    r2 = sr.Recognizer()
    url = 'https://www.porn.com/'
    with sr.Microphone() as source:
        print("Say any porn category to see there any video: ")
        audio2 = r2.listen(source)
